...
namespace PasseioCavalo.Classes
{
    internal class Cavalo
    {
        ...
        public void ResolverPasseioCavalo()
        {
            ...
            if (ResolverRecursivo(linhaInicial, colunaInicial, 2)) //começa com o segundo valor (proximoMovimento)
            {
        ...
        private bool ResolverRecursivo(int linhaAtual, int colunaAtual, int proximoMovimento)
        {
            ...
            for (int i = 0; i < movimentosPossiveis.GetLength(0); i++)
            {
                    ...
                    posicoes[proximaLinha, proximaColuna] == 0)
                {
                    ...
                    if (ResolverRecursivo(proximaLinha, proximaColuna, proximoMovimento + 1))
                    {
                        return true;
                    }
